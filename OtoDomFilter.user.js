...
(function() {
    ...
    function addWindow() {
        ...
        submitButton.addEventListener('click', function() {
            ...
            var maxPrice = parseFloat(document.getElementById('max-price-input').value);
    ...
    function countNumberAds() {
        const ulElement = document.querySelector("#__next > div.css-1i02l4.egbyzpx3 > main > div.css-1g6j91e.egbyzpx1 > div.css-feokcq.egbyzpx4 > div.css-1a3bvzb.e11vu9400 > div.css-1ktfa37.e11vu9401 > div:nth-child(2) > ul");
   ...
   function FilterAdPrices() {
    ...
    for (var y = 1; y <= x; y++) {
        var headPriceElement = document.querySelector(`#__next > div.css-1i02l4.egbyzpx3 > main > div.css-1g6j91e.egbyzpx1 > div.css-feokcq.egbyzpx4 > div.css-1a3bvzb.e11vu9400 > div.css-1ktfa37.e11vu9401 > div:nth-child(2) > ul > li:nth-child(${y}) > a > article > div.ekqt8ur0.css-1tjkj49.ei6hyam0 > span:nth-child(1)`);
    ...
    for (var z = 1; z <= x; z++) {
        var rentPriceElement = document.querySelector(`#__next > div.css-1i02l4.egbyzpx3 > main > div.css-1g6j91e.egbyzpx1 > div.css-feokcq.egbyzpx4 > div.css-1a3bvzb.e11vu9400 > div.css-1ktfa37.e11vu9401 > div:nth-child(2) > ul > li:nth-child(${z}) > a > article > div.ekqt8ur0.css-1tjkj49.ei6hyam0 > span.css-5qfobm.ei6hyam4`);
        ...
        if (rentPriceElement) {
            ...
            if (rentPriceText === '+ czynsz: poszukaj w opisie') {
                ...
                const rentPriceWithoutSuffix = rentPriceText.replace("+ czynsz: ", "").replace(" zł/miesiąc", "");
 ...
 function FilterandDelete(maxprice) {
        ...
        while (divToDelete.length > 0) {
            const divToRemove = document.querySelector(`#__next > div.css-1i02l4.egbyzpx3 > main > div.css-1g6j91e.egbyzpx1 > div.css-feokcq.egbyzpx4 > div.css-1a3bvzb.e11vu9400 > div.css-1ktfa37.e11vu9401 > div:nth-child(2) > ul > li:nth-child(${divToDelete[0] + 1})`);
            if (divToRemove) {
                divToRemove.remove();
            }
